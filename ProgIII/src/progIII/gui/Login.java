...
public class Login {
	...
	*/
	...
	private void initialize() { // definir contenidos ventana para inicializarlos
		...
		btnLogin.setFont(new Font("Tahoma", Font.BOLD, 9)); // tipo de letra y tamaño
		...
		User_passwordField = new JPasswordField();		//se utiliza para cuando queremos guardar una cotraseña, ya que siempre es algo que no se debe ver, debido a la seguridad del usuario
